...
Remove zero count genes because want to remove genes with 0 count
valules in expt
...
```
    ...
    ##  C:\Users\Kevin Banh\AppData\Local\Temp\RtmpWA8Y0q\downloaded_packages
    ...
    ##   'quantreg', 'R.utils', 'R6', 'Rcpp', 'RcppEigen', 'RCy3', 'rlang',
    ##   'rmarkdown', 'roxygen2', 'RSQLite', 'S4Vectors', 'scales', 'sp', 'sys',
    ##   'testthat', 'tidyr', 'tinytex', 'whisker', 'xfun', 'xml2'
...
```
    ...
    ## Info: Working in directory C:/Users/Kevin Banh/Desktop/BIMM 143/bimm143/Class15
