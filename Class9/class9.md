...
I can use \`length()’ to count how many matches the hoe
    has
...
Them values look hella diff so im finna use `scale=TRUE` when I run that
PCA
...
![](class9_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->

RED=cancer Cancer=messed up cells cos science
